...
class NodeTwo extends Phaser.Scene {
    ...
    create() {
        ...
        */
        ...
        // sleep bar
        this.sleeptext = this.add.text(135, 8, "Sleep: ", {fontSize: '10px', fill: '#0000ff'}).setOrigin(0.5, 0.5);
        ...
        // stress bar
        this.stresstext = this.add.text(132, 16, "Stress: ", {fontSize: '10px', fill: '#800080'}).setOrigin(0.5, 0.5);
        ...
        // homesickness bar
        this.hstext = this.add.text(118, 24, "Homesickness: ", {fontSize: '10px', fill: '#ff9900'}).setOrigin(0.5, 0.5);
